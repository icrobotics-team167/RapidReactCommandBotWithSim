...
//include these for simulating sensor data
 ...
 *
 * <p>We added the @Logged annotation to the class. This tells the Epilogue logging library to
...
public class Drive extends SubsystemBase {
  ...
  // The left-side drive encoder !! Remember, this is logged because the class is annotated with
  // @Logged
  ...
  // The right-side drive encoder !! Remember, this is logged because the class is annotated with
  // @Logged
